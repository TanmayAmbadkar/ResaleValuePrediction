...
urlpatterns = [
    ...
    path('vehicle/<int:pk>', VehicleDetailView, name = 'vehicle_detail'), #Whenever we want to view the entire details of a particular vehicle
    ...
    path('vehicle/buy/', BuyVehicle, name = 'buy')
]
